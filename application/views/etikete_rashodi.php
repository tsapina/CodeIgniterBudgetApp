<div id="page-wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="slidingHelp alert alert-success alert-dismissable">
					Etikete predstavljaju detaljnije kategorirane rashode. Klikom na gumb izlistaj etikete dobit će te izlist rashoda koji sadrže odabranu etiketu.
				</div>
			</div>
			<hr>
		<?php 
			/*Remove duplicates from $etikete_prihodi*/
			$originalArray = $etikete_rashodi; 
			$newArray = array(); 
			$usedFruits = array(); 
	...
	<?php echo form_open('statistika/etikete_rashodi') ?>
